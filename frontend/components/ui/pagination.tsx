...
function PaginationPrevious({
  ...
  return (
    <PaginationLink aria-label="Wstecz" size="default" className={cn('pl-2!', className)} {...props}>
...
function PaginationNext({
  ...
  return (
    <PaginationLink aria-label="Dalej" size="default" className={cn('pr-2!', className)} {...props}>
      <span className="hidden sm:block">{text}</span>
